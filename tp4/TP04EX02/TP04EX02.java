...
class TP04EX02 {
    ...
    public static void stackFlexible(Stack games, Game[] listGames) throws Exception {
        int size = sc.nextInt();
        String pubIn = "";
        Game game;
        ...
        for(int i=0; i<size; i++) {
            ...
            if(pubIn.equals("I")) {
                ...
                gamesRemoved[gameCounterRemoved++] = games.remove();
            }
        }
