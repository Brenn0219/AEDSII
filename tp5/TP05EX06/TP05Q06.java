...
class Hash {
    ...
    public void insert(Game game) {
        int position = hash(game.getName());

        if(games[position] == null) {
            if(position <= hash - 1) {
                games[position] = game;
            } else {
                System.out.println("Insert Hash Erro");
            }
            ...
            if(position <= hash - 1) {
                ...
                System.out.println("Insert Hash Rehash Erro");
            }
        }
    }
    ...
    public void remove(String name) {
        ...
        if(games[position].getName().equals(name)) {
            games[position] = null;
        } else {
            position++;
            
            if(position <= hash - 1) {
                if(name.equals(games[position].getName())) {
                    games[position] = null;
                }
            } else {
                System.out.println("Revome Hash Rehash Erro");
            }     
        }
    }
